...
df_pierce_county = pd.read_csv("m1_c1_kmean.csv", sep=',', header=0)
...
nn1_m1_c1 = MLPClassifier(hidden_layer_sizes = (3), activation='logistic', random_state=109)
nn1_m1_c1.fit(X_train_PC, y_train_PC)
y_pred_nn1_m1_c1 = nn1_m1_c1.predict(X_test_PC)
print("Neural Network Classifier Model Logistic: PierceCounty")

MSE = mean_squared_error(y_test_PC, y_pred_nn1_m1_c1)
print("MSE for NN with 1 hidden layers and logistic activation :",MSE)

MAPE = mean_absolute_percentage_error(y_test_PC, y_pred_nn1_m1_c1)
print("MAPE: ", MAPE)

#clf_nn_PC = MLPClassifier(hidden_layer_sizes = (10,10), activation='identity', random_state=101)
...
#clf_nn_PC = MLPClassifier(hidden_layer_sizes = (10,10), activation='tanh', random_state=101)
#clf_nn_PC.fit(X_train_PC, y_train_PC)
#y_pred_nn_PC = clf_nn_PC.predict(X_test_PC)
#print("Neural Network Classifier Model Tanh: PierceCounty")

#MSE = mean_squared_error(y_test_PC, y_pred_nn_PC)
#print("MSE for NN with 3 hidden layers and tanh activation :",MSE)

#clf_nn_PC = MLPClassifier(hidden_layer_sizes = (10,10), activation='relu', random_state=101)
#clf_nn_PC.fit(X_train_PC, y_train_PC)
#y_pred_nn_PC = clf_nn_PC.predict(X_test_PC)
#print("Neural Network Classifier Model Relu: PierceCounty")

#MSE = mean_squared_error(y_test_PC, y_pred_nn_PC)
#print("MSE for NN with 3 hidden layers and relu activation :",MSE)
