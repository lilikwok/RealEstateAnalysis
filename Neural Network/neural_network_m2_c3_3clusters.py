...
df_pierce_county = pd.read_csv("m2_c3_kmean_3clusters.csv", sep=',', header=0)
...
nn2_m2_c3 = MLPClassifier(hidden_layer_sizes = (3), activation='logistic', random_state=109)
nn2_m2_c3.fit(X_train_PC, y_train_PC)
y_pred_nn2_m2_c3 = nn2_m2_c3.predict(X_test_PC)
print("Neural Network Classifier Model logistic: PierceCounty")

MSE = mean_squared_error(y_test_PC, y_pred_nn2_m2_c3)
print("MSE for NN with 1 hidden layers and logistic activation :",MSE)

MAPE = mean_absolute_percentage_error(y_test_PC, y_pred_nn2_m2_c3)
print("MAPE: ", MAPE)

nn2_m2_c3_node2 = MLPClassifier(hidden_layer_sizes = (3,3), activation='logistic', random_state=109)
nn2_m2_c3_node2.fit(X_train_PC, y_train_PC)
y_pred_nn2_m2_c3_node2 = nn2_m2_c3_node2.predict(X_test_PC)
print("Neural Network Classifier Model Logistic: PierceCounty")

MSE = mean_squared_error(y_test_PC, y_pred_nn2_m2_c3_node2)
print("MSE for NN with 2 hidden layers and logistic activation :",MSE)

MAPE = mean_absolute_percentage_error(y_test_PC, y_pred_nn2_m2_c3_node2)
print("MAPE: ", MAPE)