...
def fullModel(m1_c1):
    ...
    export_graphviz(regressor, out_file =get_df_name(m1_c1) + '_5_cluster_tree.dot',feature_names=X.columns)  
...
def orignalModel(m2_c1):
    ...
    # for visualizing the plot easily anywhere 
    export_graphviz(regressor, out_file =get_df_name(m2_c1) + '_5_cluster_tree.dot',feature_names=X.columns) 
    feat_importance = regressor.tree_.compute_feature_importances(normalize=False)
