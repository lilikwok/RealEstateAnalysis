...
df_pierce_county = pd.read_csv("m1_c3_kmean.csv", sep=',', header=0)
...
nn1_m1_c3 = MLPClassifier(hidden_layer_sizes = (10), activation='identity', random_state=109)
...
print("MSE for NN with 1 hidden layer and identity activation :",MSE)
